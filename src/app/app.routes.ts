...
export const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadComponent: () =>
      import('../features/posts/components/post-list-page/post-list-page.component').then(
        (m) => m.PostListPageComponent,
      ),
  },
  {
    path: 'posts/create',
    ...
    loadComponent: () =>
      import('../features/posts/components/post-create-page/post-create-page.component').then(
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadComponent: () =>
      import('../features/posts/components/post-details-page/post-details-page.component').then(
